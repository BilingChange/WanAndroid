package com.bili.wanandroid.widget.behavior
...
/**
 * @description:FloatingActionButton 行为控制器
 *
 * @author: bili
...
class FloatingButtonBehavior : FloatingActionButton.Behavior {
    ...
    override fun onStartNestedScroll(
        ...
        child: FloatingActionButton, directTargetChild: View, target: View, axes: Int, type: Int
    ): Boolean {
